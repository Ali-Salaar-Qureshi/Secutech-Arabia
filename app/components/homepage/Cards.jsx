function Card(props) {
  return (
    <div className="flex flex-col items-center w-[397px] h-[545px] bg-[#0C2945] rounded-[8px] max-sm:w-[360px]">
      <img src={props.img} alt={props.alt} className="w-[395px] h-[241px] px-4 py-4" />
      <h1 className="heading-5 text-center text-white mt-4 w-70">
        {props.heading}
      </h1>
      <p className="normal-text-regular text-center text-white w-[360px] mt-4 max-sm:px-2">
        {props.text}
      </p>
