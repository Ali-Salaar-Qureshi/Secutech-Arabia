...
function NewsAndEventsCard(props){
    return(
        <div className="flex flex-col">
            ...
            <div className=" ">
            <a href="" className="mt-[-16] flex flex-row items-center gap-1"><h2 className="text-[#BE1522] small-text-regular">Full Article / Explore Insights</h2><img src="images/icons/red-arrow.png" className="w-[11px] h-[11px] mt-[-19]" alt="" /></a>
            </div>
        </div>
    );
};
