...
export default function QuoteForm() {
  ...
  // Build request body dynamically: only include non-empty fields
      ...
      <div className="bg-[#F5F5F5] w-full max-w-[1225px] p-6 sm:p-10 rounded-[16px] grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        >
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                onChange={handleChange}
                required
                className="appearance-none w-full outline-1 outline-gray-300 focus:outline-2 focus:outline-[#0F70B7] rounded-md bg-white px-3.5 py-2 text-base text-gray-900 pr-10"
              >
          ...
          <button
            ...
            className="w-full flex items-center justify-center gap-2 rounded-full bg-[#0E5B96] py-3 font-semibold text-white hover:bg-[#1c71b1] transition duration-300 disabled:opacity-60 disabled:cursor-not-allowed"
          >
            {isSubmitting && (
