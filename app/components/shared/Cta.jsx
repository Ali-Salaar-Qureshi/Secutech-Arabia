...
function CallToAction() {
  ...
  return (
    <section>
      <div className="bg-gradient-to-r from-[#7cbbe8] to-[#e47680] justify-between h-auto flex flex-row py-15 max-sm:flex-col max-sm:items-center max-sm:text-center">
        <div className="flex flex-col justify-center max-sm:mx-5 pl-15 gap-3">
