      ...
      <div className="h-auto bg-[#0C2945]">
        <div>
            ...
            <div className="flex flex-row gap-20 max-sm:gap-4 px-">
              <div className="max-sm:mx-auto">
                ...
                <ul className="list-none small-text-regular space-y-3">
                  <li className="text-[#EEEEEE]"><a href="#">Branding & UI/UX Design</a></li>
                  <li className="text-[#EEEEEE]"><a href="#">Product Development</a></li>
                  <li className="text-[#EEEEEE]"><a href="#">E-Commerce Solutions</a></li>
                  <li className="text-[#EEEEEE]"><a href="#">Digital Marketing</a></li>
                </ul>
              </div>
              <div className="max-sm:mx-auto">
                <h1 className="normal-text-bold text-white">Our Solutions</h1>
                <ul className="list-none small-text-regular space-y-3">
                  <li className="text-[#EEEEEE]"><a href="#">Video Surveillance Systems</a></li>
                  <li className="text-[#EEEEEE]"><a href="#">Security Barriers</a></li>
                  <li className="text-[#EEEEEE]"><a href="#">Access Control Systems</a></li>
                  <li className="text-[#EEEEEE]"><a href="#">POC Development</a></li>
                  <li className="text-[#EEEEEE]"><a href="#">AI Software Development</a></li>
                </ul>
              </div>
              <div className="max-sm:mx-auto">
                <h1 className="normal-text-bold text-white">General Links</h1>
                <ul className="list-none small-text-regular space-y-3">
                  <li className="text-[#EEEEEE]"><a href="#">Home</a></li>
                  <li className="text-[#EEEEEE]"><a href="#">About Us</a></li>
                  <li className="text-[#EEEEEE]"><a href="#">Contact Us</a></li>
                  <li className="text-[#EEEEEE]"><a href="#">Partners</a></li>
                  <li className="text-[#EEEEEE]"><a href="#">News & Events</a></li>
                </ul>
              </div>
            </div>
            {/* Awards Section */}
            <div className="max-sm:mt-0 max-sm:mx-auto">
              <h1 className="normal-text-bold text-white mb-3 max-sm:text-center">Awards & Certifications</h1>
          ...
          <div className="mt-10 border border-[#F5F5F51A] overflow-hidden">
            <div className="flex flex-row justify-between w-full max-sm:flex-col max-sm:items-stretch">
              ...
              {[
                ...
                },
                {
                  ...
                  content: (
                    <p className="small-text-regular text-[#EEEEEE] text-center sm:text-left">
                      Jeddah, Makkah Province,<br />Saudi Arabia
                    </p>
                  ),
                },
                {
                  ...
                  content: (
                    <>
                      <div className="flex items-center gap-2 small-text-regular text-[#EEEEEE] mb-1 justify-center sm:justify-start">
                        <img src="/images/icons/EmailIcon.png" className="w-5 h-5" alt="Email" />
                      ...
                      <div className="flex items-center gap-2 small-text-regular text-[#EEEEEE] justify-center sm:justify-start">
                        <img src="/images/icons/PhoneIcon.png" className="w-5 h-5" alt="Phone" />
                        +966 123 456 789
                      </div>
                    </>
                  ),
                ...
                <div
                  key={index}
                  className={`w-1/4 px-6 py-6 border-l border-[#F5F5F51A] max-sm:w-full max-sm:border-l-0 ${index === 0 ? "border-l-0" : ""
                    } max-sm:border-b`}
                >
                  {box.title && <h1 className="normal-text-bold text-white mb-2 text-center sm:text-left">{box.title}</h1>}
                  {box.content}
                </div>
              ))}
          ...
          <div className="flex flex-row justify-between items-center py-5 px-[100px] max-sm:flex-col max-sm:text-center max-sm:gap-3 max-sm:px-6">
            <h3 className="small-text-regular text-[#EEEEEE]">© 2025 | Secutech All rights reserved.</h3>
            <h3 className="small-text-regular text-[#EEEEEE]">Designed and Developed by DevTech Fusion.</h3>
          </div>
        </div>
      </div>
    </footer>
